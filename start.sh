...
-report feb_9_exp8b_eminst_test \
-batch_size 114 \
-triplet_positives 3 \
-optimizer adam \
-params_grid learning_rate neg_coef slope_coef overlap_coef filter_samples \
-learning_rate 1e-3 3-e3 1e-4 \
-overlap_coef 1.3 1.1 1.5 \
-slope_coef 3.0 4.0 \
-neg_coef 0.8 1.0 1.2 \
...
-filter_samples abs_margin abs_margin_asym none \
