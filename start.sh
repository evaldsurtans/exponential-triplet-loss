...
-report feb_27_exp9_mince_eminst \
-batch_size 114 \
-triplet_positives 3 \
-optimizer adam \
-params_grid learning_rate exp_coef embedding_layers_hidden_func embedding_layers embedding_size \
-learning_rate 1e-3 3e-4 1e-5 \
-overlap_coef 1.3 \
-slope_coef 1.0 \
-neg_coef 1.0 \
-embedding_layers 2 3 0 \
-embedding_layers_hidden_func l_relu kaf maxout \
