...
class BasicBlock1D(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, is_conv_bias):
        ...
        if not self.is_bottle_neck:
            self.conv1 = nn.Conv1d(in_channels, in_channels, kernel_size=3,
                                   stride=1,
                                   padding=1, bias=is_conv_bias)
            self.bn1 = nn.BatchNorm1d(in_channels)

            self.conv2 = nn.Conv1d(in_channels, in_channels, kernel_size=3,
                                   stride=1,
                                   padding=1, bias=is_conv_bias)
            ...
            self.conv2 = nn.Conv1d(in_channels, in_channels, kernel_size=3, stride=2,
            ...
            # TODO identity conv
            self.conv_res = nn.Conv1d(in_channels, out_channels, kernel_size=3, stride=2,
                                   padding=1, bias=is_conv_bias)
