...
-report jul_15_model_12_dobe_exp13_eminst_uniform \
-batch_size 33 \
-triplet_positives 3 \
-epochs_count 100 \
...
-params_grid overlap_coef class_loss_coef pos_loss_coef neg_loss_coef class_layers class_loss_epochs_limit class_layers \
