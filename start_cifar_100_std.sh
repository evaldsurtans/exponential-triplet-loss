...
-report jun_1_model_12_dobe_exp13_cifar_100_std_cos \
-batch_size 33 \
-triplet_positives 3 \
-epochs_count 300 \
-datasource_type cifar_100 \
-optimizer adam sgd \
-params_grid overlap_coef learning_rate optimizer \
-learning_rate 1e-4 1e-3 1e-1 1e-2 \
