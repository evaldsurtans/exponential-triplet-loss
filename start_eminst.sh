...
-report jun_28_model_12_dobe_exp13_eminst_unit \
-batch_size 33 \
-triplet_positives 3 \
-epochs_count 100 \
-datasource_type eminst \
-optimizer adam \
-params_grid learning_rate overlap_coef embedding_size center_loss_coef pos_loss_coef embedding_init \
