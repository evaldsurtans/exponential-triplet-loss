...
-report jul_25_model_12_dobe_exp13_cifar_100_batches \
-batch_size 33 66 99 \
-triplet_positives 3 \
-epochs_count 100 \
...
-optimizer adam \
-params_grid overlap_coef learning_rate batch_size embedding_init \
...
-class_loss_coef 2.0 \
-embedding_init uniform xavier \
-overlap_coef 1.5 20.0 \
